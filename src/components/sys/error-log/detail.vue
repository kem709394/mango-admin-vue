<template>
  <Modal v-model="visible" title="异常详情" width="800" footer-hide>
    <Form v-if="detail" :label-width="100">
      ...
      <FormItem label="说明">
        <div style="width: 600px;word-break: break-all;word-wrap: break-word;">{{ detail.content }}</div>
      </FormItem>
    </Form>
  </Modal>
</template>
...
export default {
  ...
  methods: {
    ...mapActions("sys/error_log", ["getDetail"]),
    init(id) {
