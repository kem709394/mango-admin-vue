<template>
  <Modal v-model="visible" title="修改任务">
...
export default {
  ...
  methods: {
    ...mapActions("sys/task", ["getDetail", "update"]),
    init(id) {
      this.getDetail(id).then(res => {
        this.detail = res.info;
        this.form.name = this.detail.name;
        this.form.bean = this.detail.bean;
        this.form.cron = this.detail.cron;
        this.form.params = JSON.stringify(this.detail.params);
